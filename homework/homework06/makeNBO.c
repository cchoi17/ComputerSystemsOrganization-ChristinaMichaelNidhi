...
/* int main(int argc, char *argv[]){
    //Test Portion:
    printf("%" PRId64, makeBigEndian64((long long)0x12345678));
    printf("%" PRId64, makeBigEndian64((long long)0x10482022));
    printf("%" PRId64, makeBigEndian64((long long)0x13421332));
    printf("%" PRId64, makeBigEndian64((long long)0x12820482));
