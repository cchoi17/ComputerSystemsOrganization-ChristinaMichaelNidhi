del testresults.txt
gcc dec2bin.c      -o dec2bin.exe       >> testresults.txt
gcc dec2hex.c      -o dec2hex.exe       >> testresults.txt
gcc holdit.c       -o holdit.exe        >> testresults.txt
gcc timesTables.c  -o timesTables.exe   >> testresults.txt
gcc wordcount.c    -o wordcount.exe     >> testresults.txt
